...
% delete backups of cod when updating file paths
...
for i = 1:length(letters)
    ...
    pos_folder = [backupFolder 'data_trainPos_cod_' char(string(letter_index))];
    neg_file = [backupFolder 'data_trainNeg_cod_' char(string(letter_index)) '.mat'];
